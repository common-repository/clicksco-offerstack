...
{			
	if (!is_admin())
	{
		...
		wp_enqueue_style('offerstack', plugins_url('/public/css/'.$selected_theme.'/index.css',__FILE__ ), '', OFFERSTACK_VERSION);	
		wp_enqueue_script('offerstack', plugins_url('/public/js/'.$selected_theme.'/app.js',__FILE__ ), '', OFFERSTACK_VERSION, true);	
